(function ($, window, document, undefined) {
	    ...
	    $("body").on("appear", "#gmap", function(event, $all_appeared_elements){
	    	...
	    	if (!$(this).hasClass("done")){
			    ...
			    var map = new google.maps.Map(document.getElementById('gmap'), {
				    zoom: 15,
					center: {lat: 30.267153, lng: -97.743061},//latitude and longitude
			        styles: theme_array,
					scrollwheel: false
				});
  ...
  $('.fa-facebook').attr('href','http://facebook.com/sandeeptx');
  $('.fa-linkedin').attr('href','http://linkedin.com/in/sandeep-verma');
	//if not mobile
	if( !isMobile.any() ){
